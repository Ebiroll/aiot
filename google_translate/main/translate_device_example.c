...
#define GOOGLE_TRANSLATE_LANG_FROM "en"      //https://cloud.google.com/translate/docs/languages
#define GOOGLE_TRANSLATE_LANG_TO "sv"           //https://cloud.google.com/translate/docs/languages
#define GOOGLE_TTS_LANG "sv-SE-Wavenet-A"       //https://cloud.google.com/text-to-speech/docs/voices
